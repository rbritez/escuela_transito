            ...
            <table align="center" border="1" width="100%">
                    ...
                    <tbody align="center">
                        ...
                        <tr>
                            ...
                            @foreach($assc as $assistance)
                                    @if($item->id == $assistance->postulante_id)
                                    @if ($assistance->assistance =="n/a")
                                    <td>n/a</td>
                                    @endif
                                    @if ($assistance->assistance == "P")
                                        <td>P</td>
                                    @endif
                                    @if ($assistance->assistance =="A")
                                        <td>A</td>
                                @endif
                                    @endif
                                    @endforeach
                            <td>{{$item->tipo_licencia}}</td>
                        <td>{{$item->codigo_teorico}}</td>        
                        </tr>
                        @endforeach
                    </tbody>
                </table>
